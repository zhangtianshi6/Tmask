...
next_states = []
index_save = 0
save_path = 'map/'+args_eval.save_folder.split('/')[-1]+'/'
print('save_path', args_eval.save_folder, save_path)

if not os.path.exists(save_path):
    os.mkdir(save_path)
    os.mkdir(save_path+'/img_eval1')
        ...
        if index_save>=0 and index_save<10:
            ...
            for i in range(obs.size(0)):
                ...
                for k in range(state.shape[1]):
                    ...
                    cv2.imwrite(save_path+'img_eval1/'+str(index_save)+'_'+str(i)+'_boj2_'+str(k)+'_'+str(act)+'.jpg', np_obj)
